...
namespace SharpTrooper.Core
{
    public class SharpTrooperCore
    {
        ...
        private string apiUrl = "https://swapi.co/api";
        ...
        /// <summary>
        /// request a single resources via a fully qualified URL
        /// </summary>
        private T GetSingleByURL<T>(string url, Dictionary<string, string> parameters = null) where T : SharpEntity
        {
            string serializedParameters = "";
            if (parameters != null)
            {
            ...
            return GetSingleByUrl<T>(url: url);
        }
        ...
        {
            return GetSingleByURL<Planet>(url);
        }
        ...
        {
            return GetSingleByURL<Starship>(url);
        }
        ...
        {
            return GetSingleByURL<People>(url);
        }
